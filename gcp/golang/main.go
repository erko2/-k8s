...
func main() {
    ...
    http.HandleFunc("/", func(w http.ResponseWriter, r *http.Request) {
        fmt.Fprintf(w, "Hello there! I am running in a GOLANG docker container path based routing(I am a go APP). My load is distributed through Nginx Ingress on GOOGLE CLOUD ENGINE kubernetes cluster!!!")
    })
