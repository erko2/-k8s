# Kubernetes Ingress with TLS/SSL  ==> FORKED FROM https://github.com/HoussemDellai 
# Modified according to my cluster configurations 
...
kubectl apply -f defaultapp-deploy-svc.yaml
...
kubectl delete -f defaultapp-deploy-svc.yaml
